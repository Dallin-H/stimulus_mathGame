...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__action_set__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__inline_action_observer__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__scope__ = __webpack_require__(21);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__src_indexed_multimap__ = __webpack_require__(18);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__src_attribute_observer__ = __webpack_require__(19);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__src_element_observer__ = __webpack_require__(1);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__src_token_list_observer__ = __webpack_require__(20);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_stimulus_webpack_helpers__ = __webpack_require__(27);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__src_application__ = __webpack_require__(13);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__src_controller__ = __webpack_require__(25);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__module__ = __webpack_require__(15);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__data_map__ = __webpack_require__(22);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__target_set__ = __webpack_require__(23);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__target_properties__ = __webpack_require__(26);
...
var map = {
	"./game_controller.js": 30,
	"./test_controller.js": 31
};
...
var _class = function (_Controller) {
  ...
  function _class() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = _class.__proto__ || Object.getPrototypeOf(_class)).call.apply(_ref, [this].concat(args))), _this), _this.displayNone = function (el) {
  ...
  _createClass(_class, [{
    ...
    key: "setDifficulty",
    value: function setDifficulty(el) {
    ...
    key: "next",
    value: function next() {
      var limit = this.data.get("limit");
      var operators = ["+", "-"];
      var operator = operators[this.randomInt(0, operators.length - 1)];
      if (operator == "+") {
        var digitOne = this.randomInt(1, limit / 2);
      } else {
        var digitOne = this.randomInt(limit / 2 + 1, limit);
      }
      var digitTwo = this.randomInt(0, limit / 2);
      var question = digitOne + " " + operator + " " + digitTwo;
      var answer = eval("" + digitOne + operator + digitTwo);
    ...
    key: "increment",
    value: function increment(el) {
      var score = parseInt(this.data.get(el.target.value));
      score++;
    ...
    key: "decrement",
    value: function decrement(el) {
      var score = this.data.get(el.target.value);
      if (score < 1) {
        return 0;
      } else {
        score--;
...
_class.targets = ["announcement", "question", "answer", "board", "difficulty", "check", "next", "pointsOne", "pointsTwo", "teamOne", "teamTwo"];
...
var _class = function (_Controller) {
  ...
  _createClass(_class, [{
    ...
    key: "getRandomValue",
    value: function getRandomValue(array) {
      var min = Math.ceil(0);
    ...
    key: "questions",
    get: function get() {
      return ["Do you have a burning desire to not be taken seriously?", "Do you have a need to marry someone much older than you who will control your finances?", "Do you wish to work in a dead-end job for years on end?"];
    }
  }, {
    key: "yesResponses",
    get: function get() {
      return ["You and Japan deserve each other.", "You're lying to yourself.", "You should seek help."];
    }
  }, {
    key: "noResponses",
    get: function get() {
      return ["You're a smart one.", "That's the healthy response.", "You shouldn't move to Japan.", "Like there was any other possible answer to that question."];
    }
  }]);
...
_class.targets = ["question", "response", "noButton", "yesButton", "resetButton"];
/* harmony default export */ __webpack_exports__["default"] = (_class);
